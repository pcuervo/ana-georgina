...
<div id="zo-header" class="zo-main-header zo-header-2 <?php if ( !$smof_data['menu_sticky'] && empty($zo_meta->_zo_enable_header_fixed) ) {
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <?php } ?>
            <?php if( ! is_page('category') ) { ?>
                <div id="zo-header-logo" class="col-xs-12 col-lg-3 [ text-center ]">
            <?php } ?>
	            ...
	            <a class="main-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>">
                    ...
                    <?php } ?>
                    <?php if( ! is_page('category') ) { ?>
                         <img alt="logo ana georgina" src="<?php echo THEMEPATH; ?>/images/logo-1.png">
                    <?php } ?>
                </a>
            </div>
            ...
            <?php else : ?>
                ...
                <?php } ?>
                <?php if( ! is_page('category') ) { ?>
                    <div id="zo-header-navigation" class="col-xs-12 col-lg-9">
                <?php } ?>
